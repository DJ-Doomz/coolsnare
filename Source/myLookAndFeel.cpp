...
void myLookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, float minSliderPos, float maxSliderPos, juce::Slider::SliderStyle ss , juce::Slider& slider)
{
    ...
    if (ss == juce::Slider::SliderStyle::LinearVertical)
    {
